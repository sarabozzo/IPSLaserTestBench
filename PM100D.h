/****************************************************************************
	...
	This driver supports PM100A, PM100D, PM100USB, PM160, and PM200 optical
	power meters.
	
	FOR DETAILED DESCRIPTION OF THE DRIVER FUNCTIONS SEE THE ONLINE HELP FILE
	AND THE PROGRAMMERS REFERENCE MANUAL.

	Copyright:  Copyright(c) 2008-2013, Thorlabs (www.thorlabs.com)
...
#define PM160D_PID_PM160USB_DFU        (0x8073)   // PM160 on USB with DFU interface enabled

#define PM100D_PID_PM100D              (0x8078)   // PM100D w/o DFU interface
#define PM100D_PID_PM100A              (0x8079)   // PM100A w/o DFU interface
#define PM160D_PID_PM160USB            (0x807B)   // PM160 on USB w/o DFU interface

#define PM200_PID                      (0x80B0)   // PM200 
...
// find any PM100/PM200
#define PMxxx_FIND_PATTERN            "USB?*INSTR{VI_ATTR_MANF_ID==0x1313 && (VI_ATTR_MODEL_CODE==0x8070 || VI_ATTR_MODEL_CODE==0x8078 || VI_ATTR_MODEL_CODE==0x8071 || VI_ATTR_MODEL_CODE==0x8079 || VI_ATTR_MODEL_CODE==0x8072 || VI_ATTR_MODEL_CODE==0x8073 || VI_ATTR_MODEL_CODE==0x807B || VI_ATTR_MODEL_CODE==0x80B0)}"
...
#define PM100D_STATBIT_QUES_9         (0x0200) // reserved
...
#define PM100D_STATBIT_OPER_8         (0x0100) // reserved
#define PM100D_STATBIT_OPER_9         (0x0200) // reserved
#define PM100D_STATBIT_OPER_10        (0x0400) // reserved
...
#define PM100D_STATBIT_MEAS_TEMP_FAIL (0x0100) // Temperature failure (the temperature is out of the specified window)
#define PM100D_STATBIT_MEAS_NO_SENSOR (0x0200) // The selected temperature sensor is not propperly connected
#define PM100D_STATBIT_MEAS_TEC_OPEN  (0x0400) // TEC output compliance voltage reached
#define PM100D_STATBIT_MEAS_NO_CABLE  (0x0800) // Cable connection failure
#define PM100D_STATBIT_MEAS_12        (0x1000) // reserved
#define PM100D_STATBIT_MEAS_13        (0x2000) // reserved
#define PM100D_STATBIT_MEAS_OVERTEMP  (0x4000) // The instrument's temperature is too high
#define PM100D_STATBIT_MEAS_15        (0x8000) // reserved

// Thorlabs defined Auxiliary STATUS REGISTER bit definitions
#define PM100D_STATBIT_AUX_GPIO1      (0x0001) // GPIO port #1
#define PM100D_STATBIT_AUX_GPIO2      (0x0002) // GPIO port #2
#define PM100D_STATBIT_AUX_GPIO3      (0x0004) // GPIO port #3
#define PM100D_STATBIT_AUX_GPIO4      (0x0008) // GPIO port #4
#define PM100D_STATBIT_AUX_4          (0x0010) // reserved
#define PM100D_STATBIT_AUX_5          (0x0020) // reserved
#define PM100D_STATBIT_AUX_6          (0x0040) // reserved
#define PM100D_STATBIT_AUX_7          (0x0080) // reserved
#define PM100D_STATBIT_AUX_8          (0x0100) // reserved
...
// Sensor types
#define SENSOR_TYPE_NONE               0x0   // No sensor. This value is used to mark RAM data structure for 'no sensor connected'. Do not write this value to the EEPROM.
